...
differential velocity commands, pausing at each to allow two cameras to
...
observation pose. This click-to-revisit mechanism runs through the web-based dashboard with sub-second latency. The operator freely navigates between points
