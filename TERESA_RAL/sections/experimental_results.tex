...
Spot's body and a RealSense D435 at the \ac{EE}, computing across SpotCore, an
NVIDIA Jetson, and an external PC over \ac{ROS}~2 Jazzy.  Ten supine patient
...
\begin{itemize}
  \item \textbf{Baseline}: sequential stop-and-manipulate. Fixed four-pose scan
